public class SpecialChild2 extends Parent {
    ...
    public void functionality() {
        ...
        /* 
        SpecialClass2 wants its own special functionality not the one provided by the parent. But when its own special functionality is exactly the same as that implemented by SpecialClass2, then why the code redundancy?
